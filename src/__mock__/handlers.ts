...
const authorizeHandler = http.post<LoginMutationArguments, never, LoginMutationResponse>('/authorize', () =>
  HttpResponse.json(
    {
...
const meHandler = http.get<PathParams, DefaultBodyType, GetMeQueryResponse>('/me', () => {
